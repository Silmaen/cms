...
{	
	...
	else
	{
		...
		{		
			$lien="http://www.cdf-genay.com/fiche_reservation.php?action=imprimer&id_reservation=".$row["id_reservation"]."&email=".$row["email_utilisateur"]."&cle_client=".$row["cle_client"];
	...
	$mail_subject = $prenom." ".$nom." : Confirmation de votre réservation sur le site www.cdf-genay.com";
	$mail_to = $email_temp;
	$mail_message =  " Bonjour ".$prenom." ".$nom.",
		<br /><br /> Nous vous confirmons votre réservation réalisée sur le site www.cdf-genay.com .
    ...
    //$header .= iconv_mime_encode("Subject", $mail_subject, $subject_preferences); // Mis en commentaire pour résoudre le problème Yahoo et AOL - 2021-07-03
