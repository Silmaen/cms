...
else
{
	...
	{							
		...
		{			
			...
			$pdf->MultiCell(200, 5, utf8_encode("<b>Détail des dons pour des retours entre le ".$date_debut_reglements_detail." et le ".$date_fin_reglements_detail."</b>"), 0, 'C', 0, 1, 5, ($offset_titre_clients), true,'',true);
	...
	{		
		...
		$pdf->SetFont('Helvetica', '', 16);
		$pdf->MultiCell(200, 5, utf8_encode("<b>Détail des donc pour des retours entre le ".$date_debut_reglements_detail." et le ".$date_fin_reglements_detail."</b>"), 0, 'C', 0, 1, 5, ($offset_titre_clients), true,'',true);
	...
	$pdf->MultiCell(180, 5, utf8_encode("(Cette synthèse intègre les dons reçus pour les réservations dont la date de retour est comprise dans la période demandée.)"), 0, 'L', 0, 1, 20, (($offset_clients+27)), true,'',true);
