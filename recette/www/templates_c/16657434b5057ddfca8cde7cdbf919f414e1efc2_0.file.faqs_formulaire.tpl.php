<?php
/* Smarty version 3.1.32, created on 2019-02-19 11:46:34
  from 'C:\Program Files (x86)\EasyPHP-Devserver-17\eds-www\iscriptura2019\administrateur\templates\faqs_formulaire.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.32',
  'unifunc' => 'content_5c6bde8a136434_36031697',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '16657434b5057ddfca8cde7cdbf919f414e1efc2' => 
    array (
      0 => 'C:\\Program Files (x86)\\EasyPHP-Devserver-17\\eds-www\\iscriptura2019\\administrateur\\templates\\faqs_formulaire.tpl',
      1 => 1550573009,
      2 => 'file',
    ),
  ),
...
function content_5c6bde8a136434_36031697 (Smarty_Internal_Template $_smarty_tpl) {
$_smarty_tpl->_subTemplateRender("file:header.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, $_smarty_tpl->cache_lifetime, array(), 0, false);
?>
	
	<form class="col-12 needs-validation mb-5" action="faqs_formulaire.php" method="POST">
		<input type="hidden" id="action" name="action" value="<?php echo $_smarty_tpl->tpl_vars['action']->value;?>
">
		<input type="hidden" id="id_faq" name="id_faq" value="<?php echo $_smarty_tpl->tpl_vars['id_faq']->value;?>
">
		
		<div class="form-group row">
			<label class="col-sm-2 col-form-label" for="question_fr">Question:</label>
			<div class="col-sm-10">
				<input type="text" class="form-control form-control-danger" id="question_fr" name="question_fr" value="<?php echo $_smarty_tpl->tpl_vars['question_fr']->value;?>
" required>
		...
		<div class="form-group row">
			<label class="col-sm-2 col-form-label" for="reponse_fr">Réponse:</label>
			<div class="col-sm-10">
				<textarea class="form-control form-control-danger" id="reponse_fr" name="reponse_fr"><?php echo $_smarty_tpl->tpl_vars['reponse_fr']->value;?>
</textarea>
...
" required>
				<small id="aide_ordre" class="form-text text-muted">
					Ordre d'affichage dans la liste des FAQ. Si vous souhaitez intercaler votre FAQ à la 3è place, saisissez 3. Les FAQ suivants seront automatiquement décalés.
				</small>		
...
" class="btn btn-lg btn-danger" role="button" data-toggle="tooltip" data-placement="bottom" title="Annuler" aria-pressed="true"><i class="fas fa-times-circle fa-lg"></i></a>
		...
		<?php if ($_smarty_tpl->tpl_vars['id_faq']->value != 0 && $_SESSION['droit'] == 1) {?>
...
',
						id_parent: '<?php echo $_smarty_tpl->tpl_vars['id_faq']->value;?>
'	 
					},
