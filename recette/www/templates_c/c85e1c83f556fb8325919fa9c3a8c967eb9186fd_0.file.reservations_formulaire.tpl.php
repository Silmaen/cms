<?php
/* Smarty version 3.1.32, created on 2025-07-14 19:43:56
  from '/home/cdfgenaytb/www/templates/reservations_formulaire.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.32',
  'unifunc' => 'content_687541dc8ab384_38173037',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    'c85e1c83f556fb8325919fa9c3a8c967eb9186fd' => 
    array (
      0 => '/home/cdfgenaytb/www/templates/reservations_formulaire.tpl',
      1 => 1752515034,
      2 => 'file',
    ),
  ),
...
function content_687541dc8ab384_38173037 (Smarty_Internal_Template $_smarty_tpl) {
...
<?php if ($_smarty_tpl->tpl_vars['action']->value == 'modifier-valider') {?>
	<?php $_smarty_tpl->_assignInScope('readonly_date_depart', "readonly");?>
	<?php $_smarty_tpl->_assignInScope('readonly_date_retour', "readonly");
} else { ?>
	<?php $_smarty_tpl->_assignInScope('readonly_date_depart', '');?>
	<?php $_smarty_tpl->_assignInScope('readonly_date_retour', '');
}?>
...
">
		...
		<?php if ($_smarty_tpl->tpl_vars['action']->value == 'copier-valider') {?>
...
>
			...
			<?php } else { ?>
				...
				<div class="col-sm-2">
					<input type="hidden" class="form-control form-control-danger" id="don" name="don" value="<?php echo $_smarty_tpl->tpl_vars['don']->value;?>
" <?php echo $_smarty_tpl->tpl_vars['readonly']->value;?>
>
					<div class="invalid-feedback">Veuillez saisir un don valide</div>
				</div>
...
" <?php echo $_smarty_tpl->tpl_vars['readonly_date_depart']->value;?>
 required>
				<div class="invalid-feedback">Veuillez saisir une date valide</div>
			<?php } else { ?>
				<input type="text" class="form-control form-control-danger" id="date_depart" name="date_depart" value="<?php echo $_smarty_tpl->tpl_vars['date_depart']->value;?>
...
" <?php echo $_smarty_tpl->tpl_vars['readonly_date_depart']->value;?>
  required>
			...
			<div class="col-sm-2">
				<input type="text" class="form-control form-control-danger" id="date_don" name="date_don" value="<?php echo $_smarty_tpl->tpl_vars['date_don']->value;?>
" required>
				<div class="invalid-feedback">Veuillez saisir une date valide</div>
			</div>
...
>
						...
						$("#ligne_"+<?php echo $_smarty_tpl->tpl_vars['compteur']->value;?>
).hover(function() {	

							if($(this).hasClass('<?php echo $_smarty_tpl->tpl_vars['couleur_fond']->value;?>
'))
							{
								$(this).removeClass('<?php echo $_smarty_tpl->tpl_vars['couleur_fond']->value;?>
 text-dark');
								$(this).addClass('bg-secondary text-white');
							}
							else{
								$(this).removeClass('bg-secondary text-white');
								$(this).addClass('<?php echo $_smarty_tpl->tpl_vars['couleur_fond']->value;?>
 text-dark');	
							}
						});
					<?php echo '</script'; ?>
