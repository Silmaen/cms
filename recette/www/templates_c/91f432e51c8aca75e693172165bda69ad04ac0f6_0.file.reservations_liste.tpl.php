<?php
/* Smarty version 3.1.32, created on 2024-09-09 18:04:39
  from '/home/cdfgenaytb/www/templates/reservations_liste.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.32',
  'unifunc' => 'content_66df1c97079844_27327593',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '91f432e51c8aca75e693172165bda69ad04ac0f6' => 
    array (
      0 => '/home/cdfgenaytb/www/templates/reservations_liste.tpl',
      1 => 1725897877,
      2 => 'file',
    ),
  ),
...
function content_66df1c97079844_27327593 (Smarty_Internal_Template $_smarty_tpl) {
...
$_smarty_tpl->_assignInScope('sens', 'down');?>
 ...
 <?php if ($_SESSION['filtre_statut'] == 4) {?> checked <?php }?> onchange='this.form.submit();'>
							...
							<div class="col-2 text-left">
								<input class="form-control form-check-input" type="radio" value="5" id="filtre_reservations_5" name="filtre_reservations" <?php echo $_SESSION['filtre_statut'];?>
 <?php if ($_SESSION['filtre_statut'] == 5) {?> checked <?php }?> onchange='this.form.submit();'>
...
?>
 ...
 <?php echo $_smarty_tpl->tpl_vars['liste_items']->value[(isset($_smarty_tpl->tpl_vars['__smarty_section_liste_items']->value['index']) ? $_smarty_tpl->tpl_vars['__smarty_section_liste_items']->value['index'] : null)]['prenom'];?>
					...
					<td class="col-1 text-left"><?php echo smarty_modifier_date_format($_smarty_tpl->tpl_vars['liste_items']->value[(isset($_smarty_tpl->tpl_vars['__smarty_section_liste_items']->value['index']) ? $_smarty_tpl->tpl_vars['__smarty_section_liste_items']->value['index'] : null)]['date_modification'],"%d-%m-%Y");?>
 - <?php echo smarty_modifier_date_format($_smarty_tpl->tpl_vars['liste_items']->value[(isset($_smarty_tpl->tpl_vars['__smarty_section_liste_items']->value['index']) ? $_smarty_tpl->tpl_vars['__smarty_section_liste_items']->value['index'] : null)]['heure_modification'],"%H:%M");?>
</td>
...
" class="btn btn-warning btn-sm" role="button" data-toggle="tooltip" data-placement="bottom" title="Archiver" aria-pressed="true"><i class="fa fa-archive" aria-hidden="true"></i></a>
 ...
 btn btn-danger btn-sm" data-toggle="tooltip" data-placement="bottom" title="Supprimer" aria-pressed="true"><i class="fas fa-trash-alt"></i></button>
