<?php
/* Smarty version 3.1.32, created on 2023-06-14 07:59:13
  from '/home/cdfgenaytb/www/templates/inventaires_liste.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.32',
  'unifunc' => 'content_648957314d8435_28303816',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    'b01a69e6443d72b462f82ac57998425529da10da' => 
    array (
      0 => '/home/cdfgenaytb/www/templates/inventaires_liste.tpl',
      1 => 1686676211,
      2 => 'file',
    ),
  ),
...
function content_648957314d8435_28303816 (Smarty_Internal_Template $_smarty_tpl) {
$_smarty_tpl->_checkPlugins(array(0=>array('file'=>'/home/cdfgenaytb/cgi-bin/smarty/plugins/modifier.date_format.php','function'=>'smarty_modifier_date_format',),));
					...
					<ul class="pagination pull-right">
						...
						<?php if ($_smarty_tpl->tpl_vars['page_actuelle']->value == 1) {?>
							<li class="page-item disabled">
								<a class="page-link text-vert font-weight-bold bg-gris" href="inventaires_liste.php?page=1" aria-label="Previous">
...
$_smarty_tpl->tpl_vars['foo']->first = $_smarty_tpl->tpl_vars['foo']->iteration === 1;$_smarty_tpl->tpl_vars['foo']->last = $_smarty_tpl->tpl_vars['foo']->iteration === $_smarty_tpl->tpl_vars['foo']->total;?>
							<?php if ($_smarty_tpl->tpl_vars['foo']->value == $_smarty_tpl->tpl_vars['page_actuelle']->value) {?>
								<li class="page-item disabled">
									<a class="page-link text-vert font-weight-bold bg-gris" href="inventaires_liste.php?page=<?php echo $_smarty_tpl->tpl_vars['foo']->value;?>
...
?>
						...
						<?php if ($_smarty_tpl->tpl_vars['page_actuelle']->value == $_SESSION['nombre_de_pages']) {?>
							<li class="page-item disabled">
								<a class="page-link text-vert font-weight-bold bg-gris" href="inventaires_liste.php?page=<?php echo $_smarty_tpl->tpl_vars['nombre_de_pages']->value;?>
" aria-label="Next">
						...
						<?php } else { ?>
							<li class="page-item ">
								<a class="page-link text-vert font-weight-bold bg-gris" href="inventaires_liste.php?page=<?php echo $_SESSION['nombre_de_pages'];?>
" aria-label="Next">
									<span aria-hidden="true">&raquo;</span>
									<span class="sr-only">Next</span>
								</a>
					...
					<div class="pull-right mb-3">
						<form class="mr-3" id="formulairePagination" action="inventaires_liste.php" method="post">
 ...
 par page
					...
					<div class="pull-right mb-3">
						<?php if ($_SESSION['droit'] == 1) {?>
							<a href="inventaires_formulaire.php?action=ajouter" class="btn btn-success mr-3" role="button" aria-pressed="true"><i class="fas fa-plus-circle"></i></a>
							<a href="fiche_inventaire.php?action=imprimer&type=vide" class="btn btn-orange mr-3" role="button" aria-pressed="true"><i class="fas fa-print"></i></a>
						<?php }?>
					</div>
...
?>		
 ...
 text-left align-text-bottom">
						...
						<?php if ($_SESSION['colonne'] == $_smarty_tpl->tpl_vars['liste_page']->value[(isset($_smarty_tpl->tpl_vars['__smarty_section_liste_page']->value['index']) ? $_smarty_tpl->tpl_vars['__smarty_section_liste_page']->value['index'] : null)]['colonne']) {?>
							...
							&nbsp;
							<a href="inventaires_liste.php?colonne=<?php echo $_smarty_tpl->tpl_vars['liste_page']->value[(isset($_smarty_tpl->tpl_vars['__smarty_section_liste_page']->value['index']) ? $_smarty_tpl->tpl_vars['__smarty_section_liste_page']->value['index'] : null)]['colonne'];?>
...
?>
				...
				<tr class="row">
					<td class="col-6 text-left">&nbsp;<?php echo $_smarty_tpl->tpl_vars['picto_etat']->value;?>
 &nbsp;<?php echo smarty_modifier_date_format($_smarty_tpl->tpl_vars['liste_items']->value[(isset($_smarty_tpl->tpl_vars['__smarty_section_liste_items']->value['index']) ? $_smarty_tpl->tpl_vars['__smarty_section_liste_items']->value['index'] : null)]['date_inventaire'],"%d-%m-%Y");?>
</td>
					<td class="col-2 text-left"><?php echo $_smarty_tpl->tpl_vars['liste_items']->value[(isset($_smarty_tpl->tpl_vars['__smarty_section_liste_items']->value['index']) ? $_smarty_tpl->tpl_vars['__smarty_section_liste_items']->value['index'] : null)]['libelle_type'];?>
</td>
					<td class="col-2 text-left"><?php echo $_smarty_tpl->tpl_vars['liste_items']->value[(isset($_smarty_tpl->tpl_vars['__smarty_section_liste_items']->value['index']) ? $_smarty_tpl->tpl_vars['__smarty_section_liste_items']->value['index'] : null)]['libelle_statut'];?>
</td>
					<td class="col-2 text-center">
						<a href="inventaires_formulaire.php?action=modifier&id_inventaire=<?php echo $_smarty_tpl->tpl_vars['liste_items']->value[(isset($_smarty_tpl->tpl_vars['__smarty_section_liste_items']->value['index']) ? $_smarty_tpl->tpl_vars['__smarty_section_liste_items']->value['index'] : null)]['id_inventaire'];?>
" class="btn btn-primary btn-sm" role="button" data-toggle="tooltip" data-placement="bottom" title="Modifier" aria-pressed="true"><i class="fas fa-edit"></i></a>
						...
						<a href="fiche_inventaire.php?action=imprimer&id_inventaire=<?php echo $_smarty_tpl->tpl_vars['liste_items']->value[(isset($_smarty_tpl->tpl_vars['__smarty_section_liste_items']->value['index']) ? $_smarty_tpl->tpl_vars['__smarty_section_liste_items']->value['index'] : null)]['id_inventaire'];?>
" class="btn btn-orange btn-sm" role="button" data-toggle="tooltip" data-placement="bottom" title="Imprimer un inventaire vierge" aria-pressed="true"><i class="fas fa-print"></i></a>

						<?php if ($_SESSION['id_utilisateur_groupe'] <= 2) {?>
							<a href="inventaires_formulaire.php?action=copier&id_inventaire=<?php echo $_smarty_tpl->tpl_vars['liste_items']->value[(isset($_smarty_tpl->tpl_vars['__smarty_section_liste_items']->value['index']) ? $_smarty_tpl->tpl_vars['__smarty_section_liste_items']->value['index'] : null)]['id_inventaire'];?>
" class="btn btn-secondary btn-sm" role="button" data-toggle="tooltip" data-placement="bottom" title="Copier" aria-pressed="true"><i class="fas fa-copy"></i></a>
							...
							<a href="inventaires_liste.php?action=activer&id_inventaire=<?php echo $_smarty_tpl->tpl_vars['liste_items']->value[(isset($_smarty_tpl->tpl_vars['__smarty_section_liste_items']->value['index']) ? $_smarty_tpl->tpl_vars['__smarty_section_liste_items']->value['index'] : null)]['id_inventaire'];?>
" class="btn btn-success btn-sm" role="button" data-toggle="tooltip" data-placement="bottom" title="Activer" aria-pressed="true"><i class="fa fa-play" aria-hidden="true"></i></a>
							...
							<a href="inventaires_liste.php?action=archiver&id_inventaire=<?php echo $_smarty_tpl->tpl_vars['liste_items']->value[(isset($_smarty_tpl->tpl_vars['__smarty_section_liste_items']->value['index']) ? $_smarty_tpl->tpl_vars['__smarty_section_liste_items']->value['index'] : null)]['id_inventaire'];?>
" class="btn btn-warning btn-sm" role="button" data-toggle="tooltip" data-placement="bottom" title="Archiver" aria-pressed="true"><i class="fa fa-archive" aria-hidden="true"></i></a>
							...
							<a href="inventaires_liste.php?action=supprimer&id_inventaire=<?php echo $_smarty_tpl->tpl_vars['liste_items']->value[(isset($_smarty_tpl->tpl_vars['__smarty_section_liste_items']->value['index']) ? $_smarty_tpl->tpl_vars['__smarty_section_liste_items']->value['index'] : null)]['id_inventaire'];?>
