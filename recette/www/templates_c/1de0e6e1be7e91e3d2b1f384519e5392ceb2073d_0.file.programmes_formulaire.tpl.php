<?php
/* Smarty version 3.1.32, created on 2019-02-19 11:46:47
  from 'C:\Program Files (x86)\EasyPHP-Devserver-17\eds-www\iscriptura2019\administrateur\templates\programmes_formulaire.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.32',
  'unifunc' => 'content_5c6bde973c2a72_53329221',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '1de0e6e1be7e91e3d2b1f384519e5392ceb2073d' => 
    array (
      0 => 'C:\\Program Files (x86)\\EasyPHP-Devserver-17\\eds-www\\iscriptura2019\\administrateur\\templates\\programmes_formulaire.tpl',
      1 => 1550573000,
      2 => 'file',
    ),
  ),
...
function content_5c6bde973c2a72_53329221 (Smarty_Internal_Template $_smarty_tpl) {
$_smarty_tpl->_subTemplateRender("file:header.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, $_smarty_tpl->cache_lifetime, array(), 0, false);
?>
	
	<form class="col-12 needs-validation mb-5" action="programmes_formulaire.php" method="POST">
		<input type="hidden" id="action" name="action" value="<?php echo $_smarty_tpl->tpl_vars['action']->value;?>
">
		<input type="hidden" id="id_programme" name="id_programme" value="<?php echo $_smarty_tpl->tpl_vars['id_programme']->value;?>
">
		
		<div class="form-group row">
			<label class="col-sm-2 col-form-label" for="thematique">Thématique</label>
			<div class="col-sm-10">
				<select class="form-control form-control-danger" id="id_thematique" name="id_thematique">
					
					<?php if ($_smarty_tpl->tpl_vars['id_thematique']->value != '') {?>
						<option value="<?php echo $_smarty_tpl->tpl_vars['id_thematique']->value;?>
" selected><?php echo $_smarty_tpl->tpl_vars['thematique_fr']->value;?>
</option>
					<?php }?>
					<?php
$__section_liste_thematiques_0_loop = (is_array(@$_loop=$_smarty_tpl->tpl_vars['liste_thematiques']->value) ? count($_loop) : max(0, (int) $_loop));
$__section_liste_thematiques_0_total = $__section_liste_thematiques_0_loop;
$_smarty_tpl->tpl_vars['__smarty_section_liste_thematiques'] = new Smarty_Variable(array());
if ($__section_liste_thematiques_0_total !== 0) {
for ($__section_liste_thematiques_0_iteration = 1, $_smarty_tpl->tpl_vars['__smarty_section_liste_thematiques']->value['index'] = 0; $__section_liste_thematiques_0_iteration <= $__section_liste_thematiques_0_total; $__section_liste_thematiques_0_iteration++, $_smarty_tpl->tpl_vars['__smarty_section_liste_thematiques']->value['index']++){
?>
						<option value="<?php echo $_smarty_tpl->tpl_vars['liste_thematiques']->value[(isset($_smarty_tpl->tpl_vars['__smarty_section_liste_thematiques']->value['index']) ? $_smarty_tpl->tpl_vars['__smarty_section_liste_thematiques']->value['index'] : null)]['id_thematique'];?>
"><?php echo $_smarty_tpl->tpl_vars['liste_thematiques']->value[(isset($_smarty_tpl->tpl_vars['__smarty_section_liste_thematiques']->value['index']) ? $_smarty_tpl->tpl_vars['__smarty_section_liste_thematiques']->value['index'] : null)]['thematique_fr'];?>
</option>
					<?php
}
}
...
" required>
		...
		<div class="form-group row">
			<label class="col-sm-2 col-form-label" for="contenu_fr">Contenu court:</label>
			<div class="col-sm-10">
		...
		<div class="form-group row">
			<label class="col-sm-2 col-form-label" for="contenu_long_fr">Contenu long:</label>
			<div class="col-sm-10">
				<textarea class="form-control form-control-danger" id="contenu_long_fr" name="contenu_long_fr"><?php echo $_smarty_tpl->tpl_vars['contenu_long_fr']->value;?>
</textarea>
				<div class="invalid-feedback">Veuillez saisir un contenu long valide</div>
			</div>
		</div>
		<div class="form-group row">
			<label class="col-sm-2 col-form-label" for="frequence_fr">Fréquence:</label>
			<div class="col-sm-10">
				<textarea class="form-control form-control-danger" id="frequence_fr" name="frequence_fr"><?php echo $_smarty_tpl->tpl_vars['frequence_fr']->value;?>
</textarea>
				<div class="invalid-feedback">Veuillez saisir une fréquence valide</div>
			</div>
		</div>
		<div class="form-group row">
			<label class="col-sm-2 col-form-label" for="planning_fr">Planning:</label>
			<div class="col-sm-10">
				<textarea class="form-control form-control-danger" id="planning_fr" name="planning_fr"><?php echo $_smarty_tpl->tpl_vars['planning_fr']->value;?>
</textarea>
				<div class="invalid-feedback">Veuillez saisir un planning valide</div>
			</div>
		</div>
		<div class="form-group row">
			<label class="col-sm-2 col-form-label" for="adresse">Adresse:</label>
			<div class="col-sm-10">
				<textarea class="form-control form-control-danger" id="adresse" name="adresse"><?php echo $_smarty_tpl->tpl_vars['adresse']->value;?>
</textarea>
				<div class="invalid-feedback">Veuillez saisir un adresse valide</div>
			</div>
		</div>
		<div class="form-group row">
			<label class="col-sm-2 col-form-label" for="tarif">Tarif:</label>
			<div class="col-sm-10">
				<textarea class="form-control form-control-danger" id="tarif" name="tarif"><?php echo $_smarty_tpl->tpl_vars['tarif']->value;?>
</textarea>
				<div class="invalid-feedback">Veuillez saisir un tarif valide</div>
			</div>
		</div>
...
" required>
				<small id="aide_ordre" class="form-text text-muted">
					Ordre d'affichage dans la liste des programmes. Si vous souhaitez intercaler votre programme à la 3è place, saisissez 3. Les programmes suivants seront automatiquement décalés.
				</small>		
...
" required>
		...
		<div class="form-group row">
			<label class="col-sm-2 col-form-label" for="meta_keywords_fr">Meta Keywords:</label>
			<div class="col-sm-10">
...
" class="btn btn-lg btn-danger" role="button" data-toggle="tooltip" data-placement="bottom" title="Annuler" aria-pressed="true"><i class="fas fa-times-circle fa-lg"></i></a>
		...
		<?php if ($_smarty_tpl->tpl_vars['id_programme']->value != 0 && $_SESSION['droit'] == 1) {?>
...
',
						id_parent: '<?php echo $_smarty_tpl->tpl_vars['id_programme']->value;?>
' 
					},
