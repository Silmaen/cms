...
class MYPDF extends TCPDF {
	...
	public function Footer() {
		...
		$this->writeHTMLCell(260, 10, 15, ($this->getY()+5), utf8_encode("Le mat�riel pr�t� par le Comit� des F�tes de Genay est sous la responsabilit� de l'adh�rent et doit �tre rendu propre. <b>Tout article manquant ou d�t�rior� vous sera factur�.</b>"), 0, 0, 0, true, 'J', true);
...
//////////////////////////////////////////////
	...
	foreach($liste_articles as $cle => $element)
	{
		...
		if (fmod($compteur, 20)==0)
		{
			...
			$pdf->MultiCell(260, 5, utf8_encode("Cr�� le ").$date_creation.utf8_encode(" - Modifi� le ").$date_modification.utf8_encode(" par ").$nom_membre_auteur." ".$prenom_membre_auteur, 0, 'L', 0, 1, 15, ($posy+15), true,'',true);
			...
			$pdf->MultiCell(30, 7, utf8_encode("<b>Qt�. Avant</b>"), 1, 'C', 0, 1, 140, ($offset_articles), true,'',true);
			$pdf->MultiCell(30, 7, utf8_encode("<b>Qt�. Actuelle</b>"), 1, 'C', 0, 1, 170, ($offset_articles), true,'',true);
