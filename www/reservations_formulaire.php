...
require_once('../metier/reservations.php');
...
{
	$row = ReservationLire($connexion, $id_reservation_selectionne);
	if($row===false) echo "MODIFIER - DONNEES : Pb d'accès à la table reservations";
	elseif($row!==null)
	{
...
{
	$row = ReservationLire($connexion, $id_reservation_selectionne);
	if($row===false) echo "MODIFIER TT - DONNEES : Pb d'accès à la table reservations";
	elseif($row!==null)
	{
			$smarty->assign('id_reservation',$row["id_reservation"]);
			$smarty->assign('id_client',$row["id_client"]);
...
{
	$id_reservation_selectionne = ReservationAjouter($connexion, $_POST["id_client"], $_POST["commentaire"], $_POST["don"], GestionDate($_POST["date_retour"],'1'), GestionDate($_POST["date_depart"],'1'), GestionDate($_POST["date_retour"],'1'), $_POST["annee_reservation"], $_POST["id_etat"], $_POST["id_statut_reservation"], $_SESSION["id_membre_auteur"]);
	$sql_exec = ($id_reservation_selectionne !== false);
	...
	else
	{
		...
		{
			$sql_exec = ReservationArticleAjouter($connexion, $id_reservation_selectionne, $_POST["id_article_".$i], $_POST["qtereservee_".$i], $_SESSION["id_membre_auteur"]);
		}
...
{
	$id_reservation_selectionne = ReservationAjouter($connexion, $_POST["id_client"], $_POST["commentaire"], $_POST["don"], GestionDate($_POST["date_don"],'1'), GestionDate($_POST["date_depart"],'1'), GestionDate($_POST["date_retour"],'1'), $_POST["annee_reservation"], $_POST["id_etat"], $_POST["id_statut_reservation"], $_SESSION["id_membre_auteur"]);
	$sql_exec = ($id_reservation_selectionne !== false);
...
{
	$sql_exec = ReservationModifier($connexion, $_POST["id_reservation"], $_POST["id_client"], $_POST["commentaire"], $_POST["don"], GestionDate($_POST["date_don"],'1'), GestionDate($_POST["date_depart"],'1'), GestionDate($_POST["date_retour"],'1'), $_POST["annee_reservation"], $_POST["id_etat"], $_POST["id_statut_reservation"], $_SESSION["id_membre_auteur"]);
	...
	else
	{
		...
		$sql_exec = ReservationArticlesSupprimer($connexion, $id_reservation_selectionne);
...
if($liste_etats===false) echo "LISTE : Pb d'accès à la table etats";
else $smarty->assign('liste_etats',$liste_etats);

// création de la liste des statuts des reservations
$liste_statuts = StatutsReservationsLister($connexion);
if($liste_statuts===false) echo "LISTE : Pb d'accès à la table reservations_statuts";
