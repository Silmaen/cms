<?php
/* Smarty version 3.1.32, created on 2019-02-19 11:51:48
  from 'C:\Program Files (x86)\EasyPHP-Devserver-17\eds-www\iscriptura2019\administrateur\templates\admin_utilisateurs_groupes_liste.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.32',
  'unifunc' => 'content_5c6bdfc441b623_16071565',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '135dbd7f578302b391760c1103d9805af68a2d00' => 
    array (
      0 => 'C:\\Program Files (x86)\\EasyPHP-Devserver-17\\eds-www\\iscriptura2019\\administrateur\\templates\\admin_utilisateurs_groupes_liste.tpl',
      1 => 1550573502,
      2 => 'file',
    ),
  ),
...
function content_5c6bdfc441b623_16071565 (Smarty_Internal_Template $_smarty_tpl) {
					...
					<ul class="pagination pull-right">
						...
						<?php if ($_smarty_tpl->tpl_vars['page_actuelle']->value == 1) {?>
							<li class="page-item disabled">
								<a class="page-link text-vert font-weight-bold bg-gris" href="admin_utilisateurs_groupes_liste.php?page=1" aria-label="Previous">
...
$_smarty_tpl->tpl_vars['foo']->first = $_smarty_tpl->tpl_vars['foo']->iteration === 1;$_smarty_tpl->tpl_vars['foo']->last = $_smarty_tpl->tpl_vars['foo']->iteration === $_smarty_tpl->tpl_vars['foo']->total;?>
							<?php if ($_smarty_tpl->tpl_vars['foo']->value == $_smarty_tpl->tpl_vars['page_actuelle']->value) {?>
								<li class="page-item disabled">
									<a class="page-link text-vert font-weight-bold bg-gris" href="admin_utilisateurs_groupes_liste.php?page=<?php echo $_smarty_tpl->tpl_vars['foo']->value;?>
...
?>
						...
						<?php if ($_smarty_tpl->tpl_vars['page_actuelle']->value == $_SESSION['nombre_de_pages']) {?>
							<li class="page-item disabled">
								<a class="page-link text-vert font-weight-bold bg-gris" href="admin_utilisateurs_groupes_liste.php?page=<?php echo $_SESSION['nombre_de_pages'];?>
" aria-label="Next">
...
" aria-label="Next">
					...
					<div class="pull-right mb-3">
						<form class="mr-3" id="formulairePagination" action="admin_utilisateurs_groupes_liste.php" method="post">
...
?>		
 ...
 text-left">
						<?php if ($_SESSION['colonne'] == $_smarty_tpl->tpl_vars['liste_page']->value[(isset($_smarty_tpl->tpl_vars['__smarty_section_liste_page']->value['index']) ? $_smarty_tpl->tpl_vars['__smarty_section_liste_page']->value['index'] : null)]['colonne']) {?>
							...
							&nbsp;
							<a href="admin_utilisateurs_groupes_liste.php?colonne=<?php echo $_smarty_tpl->tpl_vars['liste_page']->value[(isset($_smarty_tpl->tpl_vars['__smarty_section_liste_page']->value['index']) ? $_smarty_tpl->tpl_vars['__smarty_section_liste_page']->value['index'] : null)]['colonne'];?>
...
?>
				...
				<tr class="col-12">
					...
					<td class="text-center">
						<a href="admin_utilisateurs_groupes_formulaire.php?action=modifier&id_utilisateur_groupe=<?php echo $_smarty_tpl->tpl_vars['liste_items']->value[(isset($_smarty_tpl->tpl_vars['__smarty_section_liste_items']->value['index']) ? $_smarty_tpl->tpl_vars['__smarty_section_liste_items']->value['index'] : null)]['id_utilisateur_groupe'];?>
" class="btn btn-sm btn-success" role="button" data-toggle="tooltip" data-placement="bottom" title="Modifier" aria-pressed="true"><i class="fas fa-edit"></i></a>
						...
						<?php if ($_SESSION['droit'] == 1) {?>
							<a href="admin_utilisateurs_groupes_formulaire.php?action=copier&id_utilisateur_groupe=<?php echo $_smarty_tpl->tpl_vars['liste_items']->value[(isset($_smarty_tpl->tpl_vars['__smarty_section_liste_items']->value['index']) ? $_smarty_tpl->tpl_vars['__smarty_section_liste_items']->value['index'] : null)]['id_utilisateur_groupe'];?>
" class="btn btn-sm btn-primary" role="button" data-toggle="tooltip" data-placement="bottom" title="Copier" aria-pressed="true"><i class="fas fa-copy"></i></a>
							...
							<a href="admin_utilisateurs_groupes_liste.php?action=supprimer&id_utilisateur_groupe=<?php echo $_smarty_tpl->tpl_vars['liste_items']->value[(isset($_smarty_tpl->tpl_vars['__smarty_section_liste_items']->value['index']) ? $_smarty_tpl->tpl_vars['__smarty_section_liste_items']->value['index'] : null)]['id_utilisateur_groupe'];?>
