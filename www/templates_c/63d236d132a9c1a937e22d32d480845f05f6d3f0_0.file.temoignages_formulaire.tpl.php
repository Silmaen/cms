<?php
/* Smarty version 3.1.32, created on 2019-02-19 11:47:47
  from 'C:\Program Files (x86)\EasyPHP-Devserver-17\eds-www\iscriptura2019\administrateur\templates\temoignages_formulaire.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.32',
  'unifunc' => 'content_5c6bded3e457b9_96739339',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '63d236d132a9c1a937e22d32d480845f05f6d3f0' => 
    array (
      0 => 'C:\\Program Files (x86)\\EasyPHP-Devserver-17\\eds-www\\iscriptura2019\\administrateur\\templates\\temoignages_formulaire.tpl',
      1 => 1550572985,
      2 => 'file',
    ),
  ),
...
function content_5c6bded3e457b9_96739339 (Smarty_Internal_Template $_smarty_tpl) {
$_smarty_tpl->_subTemplateRender("file:header.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, $_smarty_tpl->cache_lifetime, array(), 0, false);
?>

	<form class="col-12 needs-validation mb-5" action="temoignages_formulaire.php" method="POST">
		<input type="hidden" id="action" name="action" value="<?php echo $_smarty_tpl->tpl_vars['action']->value;?>
">
		<input type="hidden" id="id_temoignage" name="id_temoignage" value="<?php echo $_smarty_tpl->tpl_vars['id_temoignage']->value;?>
">
...
?>
		...
		<div class="form-group row">
			...
			<div class="col-sm-10">
				<input type="text" class="form-control form-control-danger" id="pseudo" name="pseudo" value="<?php echo $_smarty_tpl->tpl_vars['pseudo']->value;?>
" required>
		...
		<div class="form-group row">
			<label class="col-sm-2 col-form-label" for="titre">Date du témoignage:</label>
			<div class="col-sm-2">
				<input type="date" class="form-control form-control-danger" id="date_temoignage" name="date_temoignage" value="<?php echo $_smarty_tpl->tpl_vars['date_temoignage']->value;?>
" required>
...
" class="btn btn-lg btn-danger" role="button" data-toggle="tooltip" data-placement="bottom" title="Annuler" aria-pressed="true"><i class="fas fa-times-circle fa-lg"></i></a>
		...
		<?php if ($_smarty_tpl->tpl_vars['id_temoignage']->value != 0 && $_SESSION['droit'] == 1) {?>
...
',
						id_parent: '<?php echo $_smarty_tpl->tpl_vars['id_temoignage']->value;?>
'			 
					},
