<?php
/* Smarty version 3.1.32, created on 2019-02-19 11:47:08
  from 'C:\Program Files (x86)\EasyPHP-Devserver-17\eds-www\iscriptura2019\administrateur\templates\publications_formulaire.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.32',
  'unifunc' => 'content_5c6bdeac22f127_79551183',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '3af402b566d00d798c70de7638704cad6638bfe7' => 
    array (
      0 => 'C:\\Program Files (x86)\\EasyPHP-Devserver-17\\eds-www\\iscriptura2019\\administrateur\\templates\\publications_formulaire.tpl',
      1 => 1550572992,
      2 => 'file',
    ),
  ),
...
function content_5c6bdeac22f127_79551183 (Smarty_Internal_Template $_smarty_tpl) {
$_smarty_tpl->_subTemplateRender("file:header.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, $_smarty_tpl->cache_lifetime, array(), 0, false);
?>

	<form class="col-12 needs-validation mb-5" action="publications_formulaire.php" method="POST">
		<input type="hidden" id="action" name="action" value="<?php echo $_smarty_tpl->tpl_vars['action']->value;?>
">
		<input type="hidden" id="id_publication" name="id_publication" value="<?php echo $_smarty_tpl->tpl_vars['id_publication']->value;?>
">
...
" required>
		...
		<div class="form-group row">
			...
			<div class="col-sm-10">
				<input type="text" class="form-control form-control-danger" id="auteur" name="auteur" value="<?php echo $_smarty_tpl->tpl_vars['auteur']->value;?>
" required>
				<div class="invalid-feedback">Veuillez saisir un auteur valide</div>
			</div>
		</div>
		
		<div class="form-group row">
			<label class="col-sm-2 col-form-label" for="editeur">Editeur:</label>
			<div class="col-sm-10">
				<input type="text" class="form-control form-control-danger" id="editeur" name="editeur" value="<?php echo $_smarty_tpl->tpl_vars['editeur']->value;?>
" required>
				<div class="invalid-feedback">Veuillez saisir un editeur valide</div>
			</div>
		</div>
		...
		<div class="form-group row">
			<label class="col-sm-2 col-form-label" for="titre">Date de la publication:</label>
			<div class="col-sm-2">
				<input type="date" class="form-control form-control-danger" id="date_publication" name="date_publication" value="<?php echo $_smarty_tpl->tpl_vars['date_publication']->value;?>
" required>
...
" required>
		...
		<div class="form-group row">
			...
			<div class="col-sm-10">
				<input type="url" class="form-control form-control-danger" id="lien" name="lien" value="<?php echo $_smarty_tpl->tpl_vars['lien']->value;?>
" required>
...
" class="btn btn-lg btn-danger" role="button" data-toggle="tooltip" data-placement="bottom" title="Annuler" aria-pressed="true"><i class="fas fa-times-circle fa-lg"></i></a>
		...
		<?php if ($_smarty_tpl->tpl_vars['id_publication']->value != 0 && $_SESSION['droit'] == 1) {?>
...
',
						id_parent: '<?php echo $_smarty_tpl->tpl_vars['id_publication']->value;?>
'			 
					},
