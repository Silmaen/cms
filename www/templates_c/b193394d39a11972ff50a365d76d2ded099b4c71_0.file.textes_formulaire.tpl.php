<?php
/* Smarty version 3.1.32, created on 2019-02-19 11:47:55
  from 'C:\Program Files (x86)\EasyPHP-Devserver-17\eds-www\iscriptura2019\administrateur\templates\textes_formulaire.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.32',
  'unifunc' => 'content_5c6bdedb0f6939_16639636',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    'b193394d39a11972ff50a365d76d2ded099b4c71' => 
    array (
      0 => 'C:\\Program Files (x86)\\EasyPHP-Devserver-17\\eds-www\\iscriptura2019\\administrateur\\templates\\textes_formulaire.tpl',
      1 => 1550572968,
      2 => 'file',
    ),
  ),
...
function content_5c6bdedb0f6939_16639636 (Smarty_Internal_Template $_smarty_tpl) {
$_smarty_tpl->_subTemplateRender("file:header.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, $_smarty_tpl->cache_lifetime, array(), 0, false);
?>

	<form class="col-12 needs-validation mb-5" action="textes_formulaire.php" method="POST">
		<input type="hidden" id="action" name="action" value="<?php echo $_smarty_tpl->tpl_vars['action']->value;?>
">
		<input type="hidden" id="id_texte" name="id_texte" value="<?php echo $_smarty_tpl->tpl_vars['id_texte']->value;?>
">
...
" required>
		...
		<div class="form-group row">
			<label class="col-sm-2 col-form-label" for="lien">Lien:</label>
			<div class="col-sm-10">
				<input type="text" class="form-control form-control-danger" id="lien" name="lien" value="<?php echo $_smarty_tpl->tpl_vars['lien']->value;?>
">
		...
		<div class="form-group row">
			<label class="col-sm-2 col-form-label" for="id_programme">Programme</label>
			<div class="col-sm-10">
				<select class="form-control form-control-danger" id="id_programme" name="id_programme">
					
					<?php if ($_smarty_tpl->tpl_vars['id_programme']->value != '') {?>
						<option value="<?php echo $_smarty_tpl->tpl_vars['id_programme']->value;?>
" selected><?php echo $_smarty_tpl->tpl_vars['titre_programme_fr']->value;?>
</option>
					<?php }?>
					<?php
$__section_liste_programmes_0_loop = (is_array(@$_loop=$_smarty_tpl->tpl_vars['liste_programmes']->value) ? count($_loop) : max(0, (int) $_loop));
$__section_liste_programmes_0_total = $__section_liste_programmes_0_loop;
$_smarty_tpl->tpl_vars['__smarty_section_liste_programmes'] = new Smarty_Variable(array());
if ($__section_liste_programmes_0_total !== 0) {
for ($__section_liste_programmes_0_iteration = 1, $_smarty_tpl->tpl_vars['__smarty_section_liste_programmes']->value['index'] = 0; $__section_liste_programmes_0_iteration <= $__section_liste_programmes_0_total; $__section_liste_programmes_0_iteration++, $_smarty_tpl->tpl_vars['__smarty_section_liste_programmes']->value['index']++){
?>
						<option value="<?php echo $_smarty_tpl->tpl_vars['liste_programmes']->value[(isset($_smarty_tpl->tpl_vars['__smarty_section_liste_programmes']->value['index']) ? $_smarty_tpl->tpl_vars['__smarty_section_liste_programmes']->value['index'] : null)]['id_programme'];?>
"><?php echo $_smarty_tpl->tpl_vars['liste_programmes']->value[(isset($_smarty_tpl->tpl_vars['__smarty_section_liste_programmes']->value['index']) ? $_smarty_tpl->tpl_vars['__smarty_section_liste_programmes']->value['index'] : null)]['titre_fr'];?>
</option>
					<?php
}
}
?>
		...
		<div class="form-group row">
			<label class="col-sm-2 col-form-label" for="auteur">Auteur</label>
			<div class="col-sm-10">
				<select class="form-control form-control-danger" id="id_auteur" name="id_auteur">
					
					<?php if ($_smarty_tpl->tpl_vars['id_auteur']->value != '') {?>
						<option value="<?php echo $_smarty_tpl->tpl_vars['id_auteur']->value;?>
" selected><?php echo $_smarty_tpl->tpl_vars['nom']->value;?>
 <?php echo $_smarty_tpl->tpl_vars['prenom']->value;?>
</option>
					<?php }?>
					<?php
$__section_liste_auteurs_1_loop = (is_array(@$_loop=$_smarty_tpl->tpl_vars['liste_auteurs']->value) ? count($_loop) : max(0, (int) $_loop));
$__section_liste_auteurs_1_total = $__section_liste_auteurs_1_loop;
$_smarty_tpl->tpl_vars['__smarty_section_liste_auteurs'] = new Smarty_Variable(array());
if ($__section_liste_auteurs_1_total !== 0) {
for ($__section_liste_auteurs_1_iteration = 1, $_smarty_tpl->tpl_vars['__smarty_section_liste_auteurs']->value['index'] = 0; $__section_liste_auteurs_1_iteration <= $__section_liste_auteurs_1_total; $__section_liste_auteurs_1_iteration++, $_smarty_tpl->tpl_vars['__smarty_section_liste_auteurs']->value['index']++){
?>
						<option value="<?php echo $_smarty_tpl->tpl_vars['liste_auteurs']->value[(isset($_smarty_tpl->tpl_vars['__smarty_section_liste_auteurs']->value['index']) ? $_smarty_tpl->tpl_vars['__smarty_section_liste_auteurs']->value['index'] : null)]['id_auteur'];?>
"><?php echo $_smarty_tpl->tpl_vars['liste_auteurs']->value[(isset($_smarty_tpl->tpl_vars['__smarty_section_liste_auteurs']->value['index']) ? $_smarty_tpl->tpl_vars['__smarty_section_liste_auteurs']->value['index'] : null)]['nom'];?>
 <?php echo $_smarty_tpl->tpl_vars['liste_auteurs']->value[(isset($_smarty_tpl->tpl_vars['__smarty_section_liste_auteurs']->value['index']) ? $_smarty_tpl->tpl_vars['__smarty_section_liste_auteurs']->value['index'] : null)]['prenom'];?>
</option>
					<?php
}
}
?>
		...
		<div class="form-group row">
			<label class="col-sm-2 col-form-label text-left" for="date_debut">Affiché du:</label>
			<div class="col-sm-2">
...
" class="btn btn-lg btn-danger" role="button" data-toggle="tooltip" data-placement="bottom" title="Annuler" aria-pressed="true"><i class="fas fa-times-circle fa-lg"></i></a>
		...
		<?php if ($_smarty_tpl->tpl_vars['id_texte']->value != 0 && $_SESSION['droit'] == 1) {?>
...
?>
				...
				$("#inputfile").fileinput({
					...
					<?php
$__section_liste_initialPreviewImages_3_loop = (is_array(@$_loop=$_smarty_tpl->tpl_vars['liste_initialPreviewImages']->value) ? count($_loop) : max(0, (int) $_loop));
$__section_liste_initialPreviewImages_3_total = $__section_liste_initialPreviewImages_3_loop;
$_smarty_tpl->tpl_vars['__smarty_section_liste_initialPreviewImages'] = new Smarty_Variable(array());
if ($__section_liste_initialPreviewImages_3_total !== 0) {
for ($__section_liste_initialPreviewImages_3_iteration = 1, $_smarty_tpl->tpl_vars['__smarty_section_liste_initialPreviewImages']->value['index'] = 0; $__section_liste_initialPreviewImages_3_iteration <= $__section_liste_initialPreviewImages_3_total; $__section_liste_initialPreviewImages_3_iteration++, $_smarty_tpl->tpl_vars['__smarty_section_liste_initialPreviewImages']->value['index']++){
$_smarty_tpl->tpl_vars['__smarty_section_liste_initialPreviewImages']->value['first'] = ($__section_liste_initialPreviewImages_3_iteration === 1);
$_smarty_tpl->tpl_vars['__smarty_section_liste_initialPreviewImages']->value['last'] = ($__section_liste_initialPreviewImages_3_iteration === $__section_liste_initialPreviewImages_3_total);
?>
...
?>		
					...
					<?php
$__section_liste_initialPreviewImages_4_loop = (is_array(@$_loop=$_smarty_tpl->tpl_vars['liste_initialPreviewImages']->value) ? count($_loop) : max(0, (int) $_loop));
$__section_liste_initialPreviewImages_4_total = $__section_liste_initialPreviewImages_4_loop;
$_smarty_tpl->tpl_vars['__smarty_section_liste_initialPreviewImages'] = new Smarty_Variable(array());
if ($__section_liste_initialPreviewImages_4_total !== 0) {
for ($__section_liste_initialPreviewImages_4_iteration = 1, $_smarty_tpl->tpl_vars['__smarty_section_liste_initialPreviewImages']->value['index'] = 0; $__section_liste_initialPreviewImages_4_iteration <= $__section_liste_initialPreviewImages_4_total; $__section_liste_initialPreviewImages_4_iteration++, $_smarty_tpl->tpl_vars['__smarty_section_liste_initialPreviewImages']->value['index']++){
$_smarty_tpl->tpl_vars['__smarty_section_liste_initialPreviewImages']->value['first'] = ($__section_liste_initialPreviewImages_4_iteration === 1);
$_smarty_tpl->tpl_vars['__smarty_section_liste_initialPreviewImages']->value['last'] = ($__section_liste_initialPreviewImages_4_iteration === $__section_liste_initialPreviewImages_4_total);
?>
...
',
						id_parent: '<?php echo $_smarty_tpl->tpl_vars['id_texte']->value;?>
'			 
					},
