<?php
/* Smarty version 3.1.32, created on 2019-04-04 11:14:54
  from 'C:\Program Files (x86)\EasyPHP-Devserver-17\eds-www\cfg\www\templates\admin_utilisateurs_liste.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.32',
  'unifunc' => 'content_5ca5cb0e74fd00_68778175',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    'f6fbdd30e7d4120d75158a25a1fd91d416438794' => 
    array (
      0 => 'C:\\Program Files (x86)\\EasyPHP-Devserver-17\\eds-www\\cfg\\www\\templates\\admin_utilisateurs_liste.tpl',
      1 => 1554193412,
      2 => 'file',
    ),
  ),
...
function content_5ca5cb0e74fd00_68778175 (Smarty_Internal_Template $_smarty_tpl) {
...
$_smarty_tpl->tpl_vars['foo']->first = $_smarty_tpl->tpl_vars['foo']->iteration === 1;$_smarty_tpl->tpl_vars['foo']->last = $_smarty_tpl->tpl_vars['foo']->iteration === $_smarty_tpl->tpl_vars['foo']->total;?>
							<?php if ($_smarty_tpl->tpl_vars['foo']->value == $_smarty_tpl->tpl_vars['page_actuelle']->value) {?>
								<li class="page-item disabled">
									<a class="page-link text-vert font-weight-bold bg-gris" href="admin_utilisateurs_liste.php?page=<?php echo $_smarty_tpl->tpl_vars['foo']->value;?>
...
?>
						...
						<?php if ($_smarty_tpl->tpl_vars['page_actuelle']->value == $_SESSION['nombre_de_pages']) {?>
							<li class="page-item disabled">
								<a class="page-link text-vert font-weight-bold bg-gris" href="admin_utilisateurs_liste.php?page=<?php echo $_SESSION['nombre_de_pages'];?>
" aria-label="Next">
...
?>		
 ...
 text-left align-text-bottom">
						...
						<?php if ($_SESSION['colonne'] == $_smarty_tpl->tpl_vars['liste_page']->value[(isset($_smarty_tpl->tpl_vars['__smarty_section_liste_page']->value['index']) ? $_smarty_tpl->tpl_vars['__smarty_section_liste_page']->value['index'] : null)]['colonne']) {?>
							...
							&nbsp;
							<a href="admin_utilisateurs_liste.php?colonne=<?php echo $_smarty_tpl->tpl_vars['liste_page']->value[(isset($_smarty_tpl->tpl_vars['__smarty_section_liste_page']->value['index']) ? $_smarty_tpl->tpl_vars['__smarty_section_liste_page']->value['index'] : null)]['colonne'];?>
...
?>
 ...
 &nbsp; <?php echo $_smarty_tpl->tpl_vars['liste_items']->value[(isset($_smarty_tpl->tpl_vars['__smarty_section_liste_items']->value['index']) ? $_smarty_tpl->tpl_vars['__smarty_section_liste_items']->value['index'] : null)]['nom_utilisateur'];?>
 <?php echo $_smarty_tpl->tpl_vars['liste_items']->value[(isset($_smarty_tpl->tpl_vars['__smarty_section_liste_items']->value['index']) ? $_smarty_tpl->tpl_vars['__smarty_section_liste_items']->value['index'] : null)]['prenom_utilisateur'];?>
</td>
					<td class="col-4 text-left"><?php echo $_smarty_tpl->tpl_vars['liste_items']->value[(isset($_smarty_tpl->tpl_vars['__smarty_section_liste_items']->value['index']) ? $_smarty_tpl->tpl_vars['__smarty_section_liste_items']->value['index'] : null)]['libelle_utilisateur_groupe'];?>
</td>
					<td class="col-2 text-center">
						<a href="admin_utilisateurs_formulaire.php?action=modifier&id_utilisateur=<?php echo $_smarty_tpl->tpl_vars['liste_items']->value[(isset($_smarty_tpl->tpl_vars['__smarty_section_liste_items']->value['index']) ? $_smarty_tpl->tpl_vars['__smarty_section_liste_items']->value['index'] : null)]['id_utilisateur'];?>
" class="btn btn-primary" role="button" data-toggle="tooltip" data-placement="bottom" title="Modifier" aria-pressed="true"><i class="fas fa-edit"></i></a>
						
						<?php if ($_SESSION['id_utilisateur_groupe'] <= 2) {?>
						
							<a href="admin_utilisateurs_formulaire.php?action=copier&id_utilisateur=<?php echo $_smarty_tpl->tpl_vars['liste_items']->value[(isset($_smarty_tpl->tpl_vars['__smarty_section_liste_items']->value['index']) ? $_smarty_tpl->tpl_vars['__smarty_section_liste_items']->value['index'] : null)]['id_utilisateur'];?>
" class="btn btn-secondary" role="button" data-toggle="tooltip" data-placement="bottom" title="Copier" aria-pressed="true"><i class="fas fa-copy"></i></a>
							
								&nbsp;					
							
							<a href="admin_utilisateurs_liste.php?action=archiver&id_utilisateur=<?php echo $_smarty_tpl->tpl_vars['liste_items']->value[(isset($_smarty_tpl->tpl_vars['__smarty_section_liste_items']->value['index']) ? $_smarty_tpl->tpl_vars['__smarty_section_liste_items']->value['index'] : null)]['id_utilisateur'];?>
" class="btn btn-success" role="button" data-toggle="tooltip" data-placement="bottom" title="Archiver" aria-pressed="true"><i class="fa fa-archive" aria-hidden="true"></i></a>

							<?php if ($_SESSION['id_utilisateur_groupe'] <= 1) {?>
							
								<a href="admin_utilisateurs_liste.php?action=supprimer&id_utilisateur=<?php echo $_smarty_tpl->tpl_vars['liste_items']->value[(isset($_smarty_tpl->tpl_vars['__smarty_section_liste_items']->value['index']) ? $_smarty_tpl->tpl_vars['__smarty_section_liste_items']->value['index'] : null)]['id_utilisateur'];?>
" class="btn btn-warning" role="button" data-toggle="tooltip" data-placement="bottom" title="Supprimer" aria-pressed="true" onclick="return confirm('Confirmez-vous la suppression?');"><i class="fas fa-trash-alt"></i></a>
							
								<a href="admin_utilisateurs_liste.php?action=activer&id_utilisateur=<?php echo $_smarty_tpl->tpl_vars['liste_items']->value[(isset($_smarty_tpl->tpl_vars['__smarty_section_liste_items']->value['index']) ? $_smarty_tpl->tpl_vars['__smarty_section_liste_items']->value['index'] : null)]['id_utilisateur'];?>
" class="btn btn-danger" role="button" data-toggle="tooltip" data-placement="bottom" title="Activer" aria-pressed="true"><i class="fa fa-play" aria-hidden="true"></i></a>
