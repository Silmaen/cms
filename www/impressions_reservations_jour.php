...
$_POST["date_depart_reservation"] = GestionDate($_POST["date_depart_reservation"],'1');	
...
$sql_exec=$sql_nb->execute([":date_depart"=>$_POST["date_depart_reservation"]]);	
...
if($nb_reservations==0)
{
	...
	$_POST["date_depart_reservation"] = GestionDate($_POST["date_depart_reservation"],'0');
	
	$pdf->SetFont('Helvetica', '', 16);
	$pdf->MultiCell(180, 5, utf8_encode("<b>Aucune réservation en date du ".$_POST["date_depart_reservation"]." </b>"), 0, 'C', 0, 1, 15, 100, true,'',true);
...
else
{
	...
	$sql_exec=$sql->execute([":date_depart"=>$_POST["date_depart_reservation"]]);	
...
$pdf->Output('fiche-reservations-jour-'.$_POST["date_depart_reservation"].'.pdf', 'D');
