...
<head>
	...
	<link rel="icon" type="image/svg+xml" href="assets/images/logo_cms.svg" />
    <meta name="viewport" content="width=device-width, initial-scale=1, shrink-to-fit=no">
	<link rel="stylesheet" href="assets/vendor/bootstrap/css/bootstrap.min.css" />
	<link rel="stylesheet" href="assets/vendor/fontawesome/css/all520.css" />
	<link rel="stylesheet" href="assets/css/styles.css" />

	<link href="assets/vendor/fontawesome/css/font-awesome.min.css" media="all" rel="stylesheet" type="text/css" />
	<link href="assets/vendor/kartik/themes/explorer-fa/theme.css" media="all" rel="stylesheet" type="text/css" />
	<link href="assets/vendor/kartik/css/fileinput.min.css" media="all" rel="stylesheet" type="text/css" />
	<link href="assets/vendor/kartik/css/fileinput-rtl.min.css" media="all" rel="stylesheet" type="text/css" />

	<script src="assets/vendor/js/jquery.min.js"  type="text/javascript"></script>
	<script src="assets/vendor/js/popper.min.js"></script>
	<script src="assets/vendor/bootstrap/js/bootstrap.min.js" type="text/javascript"></script>

    <script src="assets/vendor/kartik/js/plugins/sortable.min.js" type="text/javascript"></script>
    <script src="assets/vendor/kartik/js/plugins/purify.min.js" type="text/javascript"></script>
    <script src="assets/vendor/kartik/js/plugins/piexif.min.js" type="text/javascript"></script>
	<script src="assets/vendor/kartik/js/fileinput.min.js" type="text/javascript"></script>
	<script src="assets/vendor/kartik/js/locales/fr.js" type="text/javascript"></script>
    <script src="assets/vendor/kartik/themes/explorer-fa/theme.js" type="text/javascript"></script>
    <script src="assets/vendor/kartik/themes/fas/theme.js" type="text/javascript"></script>

	<script src="assets/js/scripts.js" type="text/javascript"></script>

	<link href="assets/vendor/js/jqueryconfirm/css/jquery-confirm.css" rel="stylesheet" type="text/css" />
	<script src="assets/vendor/js/jqueryconfirm/js/jquery-confirm.js"></script>
		...
		<div class="navbar-collapse collapse " id="navbar7">
			...
			<div class="col-2">
				<ul class="navbar-nav justify-content-end">
					<li class="nav-item">
						<a class="nav-link text-dark font-weight-bold" href="assets/aide/aide.pdf" target="_blank"title="Aide" alt="Aide"><i class="fas fa-question fa-lg"></i></a>
					</li>
