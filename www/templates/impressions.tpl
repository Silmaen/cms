			...
			<div class="col-5 border border-vert bg-light h-50 pt-3">
				<form class="col-12 needs-validation" action="impressions_reservations_jour.php" method="POST">
					...
					<div class="row col-12 form-group">			
						...
						<div class="col-4">
							<input type="text" class="form-control form-control-danger" id="date_depart_reservation" name="date_depart_reservation" value="<!--{$aujourdhui}-->" onkeydown="return false" >
						</div>				
						<div class="col-1">							
					...
					<form class="col-12 needs-validation" action="impressions_reglements_recus.php" method="POST">
						...
						<div class="row col-12 form-group">			
							...
							<div class="col-3 text-center bg-light">
								<input type="text" class="form-control form-control-danger" id="date_debut_reglements_synthese" name="date_debut_reglements_synthese" value="<!--{$aujourdhui}-->" onkeydown="return false" >
							</div>				

							<label class="col-1 col-form-label" for="date_fin_reglements_synthese"><b>et le</b></label>			
							<div class="col-3 text-center bg-light">
								<input type="text" class="form-control form-control-danger" id="date_fin_reglements_synthese" name="date_fin_reglements_synthese" value="<!--{$aujourdhui}-->" onkeydown="return false" >
							</div>				
			...
			<div class="col-5 border border-vert bg-light h-50 pt-3">
				<form class="col-12 needs-validation" action="impressions_reservations_retour.php" method="POST">
					...
					<div class="row col-12 form-group">			
						...
						<div class="col-4">
							<input type="text" class="form-control form-control-danger" id="date_retour_reservation" name="date_retour_reservation" value="<!--{$aujourdhui}-->" onkeydown="return false" >
						</div>				
						<div class="col-1">							
							<button id="btnSubmit" type="submit" class="btn btn-vert"><i class="fas fa-print fa-lg"></i></button>
						</div>
				...
				<!--{if $smarty.session.id_utilisateur_groupe<=1}-->
					...
					<form class="col-12 needs-validation" action="impressions_reglements_detail.php" method="POST">
						...
						<div class="row col-12 form-group">			
							...
							<div class="col-3 text-center bg-light">
								<input type="text" class="form-control form-control-danger" id="date_debut_reglements_detail" name="date_debut_reglements_detail" value="<!--{$aujourdhui}-->" onkeydown="return false" >
							</div>				

							<label class="col-1 col-form-label" for="date_fin_reglements_detail"><b>et le</b></label>			
							<div class="col-3 text-center bg-light">
								<input type="text" class="form-control form-control-danger" id="date_fin_reglements_detail" name="date_fin_reglements_detail" value="<!--{$aujourdhui}-->" onkeydown="return false" >
							</div>				
			...
			<div class="col-5 border border-vert bg-light h-50 pt-3">
				<form class="col-12 needs-validation" action="impressions_articles_jour.php" method="POST">
					...
					<div class="row col-12 form-group">			
						...
						<div class="col-4">
							<input type="text" class="form-control form-control-danger" id="date_depart_article" name="date_depart_article" value="<!--{$aujourdhui}-->" onkeydown="return false" >
						</div>				
						<div class="col-1">							
							<button id="btnSubmit" type="submit" class="btn btn-vert"><i class="fas fa-print fa-lg"></i></button>
						</div>
