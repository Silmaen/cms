...
//////////////////////////////////////////////	
	...
	foreach($liste_articles as $cle => $element)
	{
		...
		if (fmod($compteur, 48)==0)
		{
			...
			$pdf->MultiCell(170, 5, utf8_encode("Créé le ").$date_creation.utf8_encode(" - Modifié le ").$date_modification.utf8_encode(" par ").$nom_membre_auteur." ".$prenom_membre_auteur, 0, 'L', 0, 1, 15, ($posy+15), true,'',true);
			...
			$pdf->MultiCell(20, 5, utf8_encode("<b>Qté. Avant</b>"), 1, 'C', 0, 1, 75, ($offset_articles), true,'',true);
			$pdf->MultiCell(20, 5, utf8_encode("<b>Qté. Actuelle</b>"), 1, 'C', 0, 1, 95, ($offset_articles), true,'',true);
